...
static const _ImuData_type_support_symbol_names_t _ImuData_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, esp32_msgs, msg, ImuData)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, esp32_msgs, msg, ImuData)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, esp32_msgs, msg, ImuData)() {
  return &::esp32_msgs::msg::rosidl_typesupport_c::ImuData_message_type_support_handle;
}
