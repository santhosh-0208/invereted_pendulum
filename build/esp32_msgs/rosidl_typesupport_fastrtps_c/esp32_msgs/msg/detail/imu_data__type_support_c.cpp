...
#include "esp32_msgs/msg/detail/imu_data__rosidl_typesupport_fastrtps_c.h"
...
#include "esp32_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _ImuData__ros_msg_type = esp32_msgs__msg__ImuData;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_esp32_msgs
size_t get_serialized_size_esp32_msgs__msg__ImuData(
  const void * untyped_ros_message,
...
static uint32_t _ImuData__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_esp32_msgs__msg__ImuData(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_esp32_msgs
size_t max_serialized_size_esp32_msgs__msg__ImuData(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = esp32_msgs__msg__ImuData;
    is_plain =
      (
...
static size_t _ImuData__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_esp32_msgs__msg__ImuData(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, esp32_msgs, msg, ImuData)() {
