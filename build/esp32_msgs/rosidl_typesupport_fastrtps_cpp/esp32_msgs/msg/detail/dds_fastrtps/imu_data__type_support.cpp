...
#include "esp32_msgs/msg/detail/imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = esp32_msgs::msg::ImuData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const esp32_msgs::msg::ImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<esp32_msgs::msg::ImuData *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_esp32_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<esp32_msgs::msg::ImuData>()
{
  return &esp32_msgs::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
