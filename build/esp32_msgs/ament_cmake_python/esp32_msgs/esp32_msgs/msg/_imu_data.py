...
class Metaclass_ImuData(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('esp32_msgs')
        except ImportError:
            import logging
            import traceback
            logger = logging.getLogger(
                'esp32_msgs.msg.ImuData')
            logger.debug(
...
class ImuData(metaclass=Metaclass_ImuData):
    ...
    def __init__(self, **kwargs):
        ...
        self.ax = kwargs.get('ax', int())
        self.ay = kwargs.get('ay', int())
    ...
    def ax(self, value):
        if __debug__:
            assert \
                ...
                "The 'ax' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'ax' field must be an integer in [-32768, 32767]"
        self._ax = value
    ...
    def ay(self, value):
        if __debug__:
            assert \
                isinstance(value, int), \
                "The 'ay' field must be of type 'int'"
            assert value >= -32768 and value < 32768, \
                "The 'ay' field must be an integer in [-32768, 32767]"
        self._ay = value
    ...
    def az(self, value):
        if __debug__:
            ...
            assert value >= -32768 and value < 32768, \
                "The 'az' field must be an integer in [-32768, 32767]"
        self._az = value
